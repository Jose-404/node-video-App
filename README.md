...
2. http://localhost:3000/player -> Here you have to enter the name of your video in the search bar, and then the media player will open up with your video.
